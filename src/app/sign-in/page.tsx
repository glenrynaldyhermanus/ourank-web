...
function SignInPageContent() {
	...
	return (
		<div className="min-h-screen bg-gray-50 flex page-transition">
			{/* Background Image Section - Only visible on desktop */}
			<div className="hidden lg:flex lg:w-3/4 relative section-stagger">
			...
			{/* Form Section */}
			<div className="flex-1 lg:w-1/4 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 xl:px-12 section-stagger">
